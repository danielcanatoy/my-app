...
export default function Home() {
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5x1 mx-auto text-center space-y-8">
        <h1 className="text-5xl md:text-7xl lg:text-8xl mb-6 gradient-title">
          Ink Your Thoughts. <br /> Shape Your Future.
        </h1>
        <p className="text-ig md:text-x1 text-orange-800 mb-8">
          ...
          <CardContent className="p-12 text-center">
            ...
            <Link href="/dashboard">
              <Button size-lg variant="journal" className="animate-bounce">
                Get Started for Free <ChevronRight className="ml-2 h-4 w-3" />
              </Button>
            </Link>
          </CardContent>
        </Card>
